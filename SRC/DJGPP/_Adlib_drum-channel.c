...
// GB 24-10-2014 
// This is the fixed Adlib driver, 
// This version is still in 'Drum Channel' mode
// (The drum channel mode was changed to melodic mode for Doom Music)
