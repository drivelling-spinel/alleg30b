...
{
   int pan, flip_pan_correct;

   if (digi_driver->name[19]=='#') // GB 2017, Sound Blaster Pro = Reversed stereo in hardware
     flip_pan_correct = !_flip_pan; 
   else 
	 flip_pan_correct = _flip_pan;
...
{
   int flip_pan_correct;

   if (digi_driver->name[19]=='#')
     flip_pan_correct = !_flip_pan; // GB 2017, Sound Blaster Pro = Reversed stereo in hardware
   else 
	 flip_pan_correct = _flip_pan;
